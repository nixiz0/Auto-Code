...
def interact_with_user():
    ...
    if not os.path.exists('functions/prompt_engineering/temp_modelfile'):
        os.makedirs('functions/prompt_engineering/temp_modelfile')

    # Create the Modelfile
    with open('functions/prompt_engineering/temp_modelfile/Modelfile', 'w') as f:
        f.write('')

    # Open the file via a text editor
    if platform.system() == 'Windows':
        os.startfile(os.path.abspath('functions/prompt_engineering/temp_modelfile/Modelfile'))
    elif platform.system() == 'Linux':
        subprocess.run(["xdg-open", os.path.abspath('functions/prompt_engineering/temp_modelfile/Modelfile')])
    ...
    subprocess.run(["ollama", "create", model_name, "--file", os.path.abspath('functions/prompt_engineering/temp_modelfile/Modelfile')])
